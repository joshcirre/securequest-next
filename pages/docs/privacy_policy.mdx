...
Please be aware that this Privacy Policy does not govern all the information Help Scout may process. Our commitment to customers and service providers is governed by a separate [Data Processing Amendment](https://www.helpscout.com/company/legal/dpa/).
...
-   [Whose information does Help Scout collect?](https://www.helpscout.com/company/legal/privacy/#section-one)
-   [What information does Help Scout collect?](https://www.helpscout.com/company/legal/privacy/#section-two)
-   [What data does Help Scout collect from customers using Beacon?](https://www.helpscout.com/company/legal/privacy/#section-eighteen)
-   [What data does Help Scout collect from customers using Google integrations?](https://www.helpscout.com/company/legal/privacy/#section-three)
-   [When does Help Scout use end user information from third parties?](https://www.helpscout.com/company/legal/privacy/#section-four)
-   [When does Help Scout use customer information from third parties?](https://www.helpscout.com/company/legal/privacy/#section-five)
-   [Where and when is information collected from customers and end users?](https://www.helpscout.com/company/legal/privacy/#section-six)
-   [Does Help Scout collect information from children under 16 years of age?](https://www.helpscout.com/company/legal/privacy/#section-seven)
-   [What does Help Scout do with the information it collects from customers?](https://www.helpscout.com/company/legal/privacy/#section-eight)
-   [What does Help Scout do with the information it collects from end users?](https://www.helpscout.com/company/legal/privacy/#section-nine)
-   [Does this Privacy Policy apply when I link to other websites or services?](https://www.helpscout.com/company/legal/privacy/#section-ten)
-   [When does Help Scout disclose information to other third parties?](https://www.helpscout.com/company/legal/privacy/#section-eleven)
-   [Could my information be transferred to other countries?](https://www.helpscout.com/company/legal/privacy/#section-twelve)
-   [Is the information collected through the Help Scout Service secure?](https://www.helpscout.com/company/legal/privacy/#section-thirteen)
-   [What rights are offered to California residents?](https://www.helpscout.com/company/legal/privacy/#section-fourteen)
-   [What choices do I have regarding the collection, disclosure and distribution of personal information?](https://www.helpscout.com/company/legal/privacy/#section-fifteen)
-   [How will I know if there are any changes to this Privacy Policy?](https://www.helpscout.com/company/legal/privacy/#section-sixteen)
-   [Whom do I contact if I have any privacy questions?](https://www.helpscout.com/company/legal/privacy/#section-seventeen)

### Whose information does Help Scout collect?

Help Scout collects information from three types of individuals:

Our *customers* are individuals and businesses who have signed up for a Help Scout account. If you are a customer, we will handle information we receive from you under the terms of Help Scout's [Data Processing Amendment](https://www.helpscout.com/company/legal/dpa/).
...
*Personnel* are the people who work, and apply to work, for Help Scout. Please refer to the [Personnel section](https://www.helpscout.com/company/legal/privacy/#personnel) of this policy to read about the information Help Scout collects from personnel.

[Back to top](https://www.helpscout.com/company/legal/privacy/#toc)
...
- "Custom Data" - custom attributes defined by Help Scout's Customer ( e.g. Plan Name, Account Type, Twitter Handle, etc). | To prefill the contact form with the Customer's information, fetch the Customer's Previous Conversations, and display custom data on the Beacon Sidebar application within Help Scout |
...
We may use End User Data to look up and store additional Public Data in order to create a more complete customer profile. "Public Data" is defined as information received from a third party partner named [FullContact](https://www.fullcontact.com/). Public Data may be claimed, edited or discarded from their systems by [following this link](https://www.fullcontact.com/privacy/claim/) and is subject to their [Privacy Policy](https://www.fullcontact.com/privacy/).
...
We also use "Page Tags" and "Log Files." For more information about these and a full list of the cookies we use, what they do, and how to disable the non-necessary ones, please refer to our full [Cookie Policy](https://www.helpscout.com/company/legal/cookie-policy/).
...
Except as set forth in this Privacy Policy, the [Cookie Policy](https://www.helpscout.com/company/legal/cookie-policy/) or the Help Scout [Data Processing Amendment](https://www.helpscout.com/company/legal/dpa/) or as specifically authorized by a Help Scout customer, we will not disclose any information to third parties.
...
Help Scout also maintains ongoing compliance with the U.S. Health Insurance Portability and Accountability Act (HIPAA) and is able to process, maintain and store protected health information for any entities restricted by these regulations. [On request](https://www.helpscout.com/contact/), Help Scout will sign a business associate agreement (BAA) with your organization.

![HIPAA Compliant badge](https://hs-marketing.imgix.net/images/uploads/CompanyPage--accountable.png?auto=compress,format&fit=scale&dpr=2)

For more information about how Help Scout stores and secures customer and company data, please see our [Security Policy](https://www.helpscout.com/company/legal/security/).
...
-   [By email](https://www.helpscout.com/contact/)
