          ...
          opacity-100 "
            ...
            <Dialog open={open}>
                <DialogContent className="sm:max-w-[850px] text-black">
                    <DialogHeader>
                        <DialogTitle>Help Scout Security Search</DialogTitle>
                        <DialogDescription>
                            Ask our public facing security documentation questions about how we handle security at Help Scout.
                        </DialogDescription>
                        <hr />
                  ...
                  transition-colors"
                                    onClick={(_) =>
                                        setSearch('Are files encrypted at rest?')
                                    }
                                >
